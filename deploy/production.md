...
CR-011 final domain check: GitHub Pages run `35501286587` for commit `5b720b3` succeeded. `https://potato.minizap.online` returns HTTPS 200 and serves v0.6.0. The initial TLS failure resolved during the owner-managed migration. GitHub repository rename remains separate.
